...
| H1 | 执行器与 IMU 资格测试 | ¥600–1,000 | C044/C046 50 Hz、step、速度、温升、延迟、断连数据归档；完成选型 |
| H2 | 一条 5DOF 实体腿 | ¥1,200–1,900 | 支架上 30 min 轨迹、无机械干涉、峰值电流已知 |
| H3 | 10DOF 全身 Stand | ¥2,500–4,000 | 外部限流供电；10 次上电至少 8 次安全 stand；brownout=0 |
| H4 | 无绳 2 m 行走 | ¥2,800–4,500 | 2 m ×10，至少 7 次成功 |
